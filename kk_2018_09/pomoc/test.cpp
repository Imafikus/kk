...
int main() {
  ...
  /* Sabiranje */
  x1 = Builder.CreateAdd(ConstantInt::get(TheContext, APInt(32, 2)), ConstantInt::get(TheContext, APInt(32, 4)), "addtmp");
  ArgsV[1] = x1;
  Builder.CreateCall(PrintfFja, ArgsV, "printfCall");

  /* Manje od */
  x1 = Builder.CreateICmpULT(ConstantInt::get(TheContext, APInt(32, 2)), ConstantInt::get(TheContext, APInt(32, 2)), "lttmp");
  ArgsV[1] = x1;
  Builder.CreateCall(PrintfFja, ArgsV, "printfCall");
  ...
  /* ispis llvm koda (u verziji > 5 umesto dump ide print) */
